...
>>>>>>> 19337b0429d6684e52f8c34222ca2f2ad433a226
        </div>
...
=======
          ...
          <a href="/terms" className="text-gray-400 hover:text-white">Terms of Service</a><br/>
          <hr style={{borderColor:'red',borderRadius:'2px'}}></hr>
        </div>
      </div>
      <div className="container mx-auto text-center pr-10 flex flex-wrap flex-row lg:gap-16 pb-4">
        <div className="text-gray-400 lg:pl-3">&copy; 2023 Conference Name. All rights reserved.</div>
        <div className="text-gray-400">* Final Approval Pending</div>
        <div className="text-gray-400  lg:pl-[120px]">Designed and Maintained by: Ashutosh Singh & Arun Singh</div>
