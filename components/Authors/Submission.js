...
export default function Submission() {
    return (
        <div>
            ...
            <a className='pb-1 font-bold text-blue-400 text-2xl w-1/2' href="https://www.springer.com/gp/computer-science/lncs/conference-proceedings-guidelines" >Formatting Guidelines: http://www.springer.com/computer/lncs?SGWID=0-164-6-793341-0 </a>
